...
// shop
    ...
    cartButton.addEventListener('click', e => {
        ...
        const plus = document.querySelector('.bi-plus-lg');
        const minus = document.querySelector('.bi-dash-lg');
        plus.addEventListener('click', e => {
            e.preventDefault();
            cartIncrement(basket.id);
        });

        minus.addEventListener('click', e => {
            e.preventDefault();
            cartDecrement(basket.id);
        });
